...
const Chat = () => {
  ...
  if (!currentUser) return <div className="p-10 text-center">Loading user profile...</div>;
    ...
    <div className="flex flex-col h-screen bg-white">
      ...
      <header className="flex items-center justify-between px-6 py-4 border-b bg-white shrink-0">
        ...
        <div className="flex items-center gap-3">
          ...
          <img src={currentUser.avatar || "/default-avatar.png"} className="w-8 h-8 rounded-full border" alt="" />
        </div>
      </header>
                        ...
                        <div
                          className={`max-w-[80%] p-4 rounded-2xl shadow-sm ${
                            isMine
                              ...
                              : "bg-white text-zinc-900 border rounded-bl-none"
                          }`}
                        >
              ...
              <div className="p-4 border-t bg-white shrink-0">
                <form onSubmit={handleSendMessage} className="flex gap-2">
                  <input
                    ...
                    className="flex-1 bg-stone-50 border-zinc-200 border rounded-full px-6 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-zinc-900 transition"
                  />
                  <button
                    type="submit"
