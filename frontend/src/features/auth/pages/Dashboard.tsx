          ...
          <div className="flex flex-wrap gap-2">
            {categories.map((cat) => (
              <button
                ...
                className={`rounded-full px-5 py-2 text-sm font-medium transition ${selectedCategory === cat
                    ? "bg-black text-white"
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
              {filteredPosts.map((post) => {
                const postedBy = post.postedBy && typeof post.postedBy === "object"
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mb-6 grid grid-cols-2 gap-4 rounded-3xl bg-zinc-50 p-4">
                      <div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-zinc-500">
                            {postedBy?.university || "No University"}
                          </p>
                        </div>
                      </div>
                      <Link
